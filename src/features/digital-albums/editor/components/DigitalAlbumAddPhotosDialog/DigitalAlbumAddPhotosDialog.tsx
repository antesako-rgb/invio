...
import DigitalAlbumPhotoPicker
  from "@/features/digital-albums/editor/components/DigitalAlbumPhotoPicker/DigitalAlbumPhotoPicker";

import DigitalAlbumUpload
  from "@/features/digital-albums/editor/components/DigitalAlbumUpload/DigitalAlbumUpload";
...
import PhotoUploadDialog
  from "@/features/photo-upload/components/PhotoUploadDialog/PhotoUploadDialog";
...
import styles
  from "./DigitalAlbumAddPhotosDialog.module.css";
...
export default function DigitalAlbumAddPhotosDialog({
  ...
  const t =
    useTranslations(
      "DigitalAlbumEditor.photos.addDialog"
    );
  ...
  const [
    ...
    useState<DigitalAlbumAddPhotosStep>(
      "source"
    );
  ...
  function handlePhotoWallSelect(
    photoWallId:
      string
  ) {
    if (
      ...
      {step ===
        ...
        <>
          <DialogHeader>
            <DialogTitle>
              {t(
                "photoWallSelect.title"
              )}
            </DialogTitle>

            <DialogDescription>
              {t(
                "photoWallSelect.description"
              )}
            </DialogDescription>
          </DialogHeader>
